...
public class Langeo extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "langeo/v1/users/";
  ...
  public class LangeoAPI {
    ...
    public class GetUser extends LangeoRequest<com.appspot.myapplicationid.langeo.model.User> {
      ...
      protected GetUser(java.lang.String id) {
        super(Langeo.this, "GET", REST_PATH, null, com.appspot.myapplicationid.langeo.model.User.class);
     ...
     *
     * @param id
     * @param content the {@link com.appspot.myapplicationid.langeo.model.User}
     * @return the request
     */
    public PutUser putUser(java.lang.String id, com.appspot.myapplicationid.langeo.model.User content) throws java.io.IOException {
    ...
    public class PutUser extends LangeoRequest<Void> {
       ...
       * @since 1.13
       */
      protected PutUser(java.lang.String id, com.appspot.myapplicationid.langeo.model.User content) {
